                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="post" enctype="multipart/form-data" action="tambah_proposal_action">
                                <input type="hidden" name="ket" value="Proposal" required>
                                <div class="form-group">
                                    <label for="exampleInputName1">Periode</label>
                                    <input type="text" class="form-control" name="priode" id="exampleInputName1" placeholder="Priode">
                                </div>
                                <div class="form-group">
                                    <label>File upload</label>
                                    <input type="file" id="gambar" name="file" class="form-control file-upload-info" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="id_user" id="exampleSelectGender">
                                        ...
                                        <option value="5">Teknik Informatika</option>
                                        <option value="6">Teknik Mesin</option>
                                        <option value="7">Teknik Elektronika</option>
                                        <option value="8">Teknik Telekomunikasi</option>
                                        <option value="9">Teknik Mekatronika</option>
                                        <option value="10">Teknik Elektronika Telekomunikasi</option>
                                        <option value="12">Teknik Komputer</option>
                                        <option value="13">Teknik Listrik</option>
                                ...
                                <a href="<?php echo site_url('home/proposal') ?>" class="btn btn-light">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
