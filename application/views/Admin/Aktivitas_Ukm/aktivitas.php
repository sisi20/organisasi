                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="text-center"><?php echo $value->link; ?><?php echo $value->ruangan; ?></td>
                              ...
                              <td class="text-center">
                                <a href="<?php echo site_url('ukm/edit/' . $value->id) ?>">
                                  <button class="btn btn-outline-facebook">Edit
                                    <i class="mdi mdi-lead-pencil btn-icon-append"></i>
                                  </button>
                                </a>
                                <a href="<?php echo site_url('ukm/delete_aktivitas/' . $value->id ) ?>">
