                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="text-center"><?php echo $value->mode; ?></td>
                              <td class="text-center"><?php echo $value->waktu; ?></td>
                              <td class="text-center"><?php echo $value->ket; ?></td>
                              <td class="text-center"><?php echo $value->link; ?>
                                <?php echo $value->ruangan; ?></td>
                              <td class="text-center"><?php echo $value->kategori; ?></td>
                              <td class="text-center"><img src="<?php echo base_url(); ?>assets/aktivitas/<?php echo $value->gambar; ?>" width=100 height=120></td>
                              <td class="text-center">
                                <a href="<?php echo site_url('hima/edit/' . $value->id) ?>">
                                  <button class="btn btn-outline-facebook">Edit
                                    <i class="mdi mdi-lead-pencil btn-icon-append"></i>
                                  </button>
                                </a>
                                <a href="<?php echo site_url('hima/delete_aktivitas/' . $value->id ) ?>">
