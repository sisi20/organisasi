                ...
                <li class="nav-item nav-profile dropdown">
                    ...
                    ?>
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="<?php echo base_url(); ?>assets/profil/<?php echo $value->foto; ?>" alt="profile" />
                                    ...
                                    <div class="col-lg-12">
                                        <div class="border-bottom text-center pb-4">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <a href="<?php echo site_url('user/edit_profil/' . $value->id_user) ?>">
                                                    <button class="btn btn-success mr-1">Edit Data</button>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="border-bottom py-4">
                                            <div class="d-flex mb-3">
                                                <div class="progress progress-md flex-grow">
                                                    <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="55" style="width: 100%" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <div class="progress progress-md flex-grow">
