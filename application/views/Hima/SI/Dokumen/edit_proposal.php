                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="post" enctype="multipart/form-data" action="../edit_proposal_action">
                                <input type="hidden" name="id" value="<?php if (isset($dokumen->id)) {
                                                                            echo $dokumen->id;
                                                                        } ?>" required>
                                <input type="hidden" name="id_user" value="<?php if (isset($dokumen->id_user)) {
                                                                                echo $dokumen->id_user;
                                                                            } ?>" required>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="priode" value="<?php if (isset($dokumen->priode)) {
                                                                                                        echo $dokumen->priode;
                                                                                                    } ?>" id="exampleInputName1" placeholder="Priode">
                                </div>
                                <div class="form-group">
