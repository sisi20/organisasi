                        ...
                        <div class="card-body">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="<?php echo $value->username; ?>" id="exampleInputName1" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName1">Email</label>
                                    <input class="form-control" value="<?php echo $value->email; ?>" id="exampleInputName1" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="exampleTextarea1">Password</label>
                                    <input class="form-control" value="<?php echo $value->password; ?>" disabled>
                                </div>
                                <?php } ?>
                                <a href="<?php echo site_url('si/edit_user/' .$_SESSION['user']->id_user) ?>">
