                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="post" enctype="multipart/form-data" action="tambah_lpj_action">
                                <input type="hidden" name="ket" value="LPJ" required>
                                ...
                                <a href="<?php echo site_url('home/lpj') ?>" class="btn btn-light">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
