                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="text-center"><?php echo $value->nim; ?></td>
                              <td class="text-center"><?php echo $value->jabatan; ?></td>
                              <td class="text-center"><img src="<?php echo base_url(); ?>assets/pengurus/<?php echo $value->gambar; ?>" width=100 height=120></td>
                              <td class="text-center"><?php echo $value->prodi; ?></td>
                              <td class="text-center">
                                <a href="<?php echo site_url('hima/edit_pengurus/' . $value->id) ?>">
                                  <button class="btn btn-outline-facebook">Edit
                                    <i class="mdi mdi-lead-pencil btn-icon-append"></i>
                                  </button>
                                </a>
                                <a href="<?php echo site_url('hima/delete_pengurus/' . $value->id ) ?>">
