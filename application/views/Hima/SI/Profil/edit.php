        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Form Edit Hima</h4>

                            <form class="forms-sample" method="post" action="../edit_hima_action">
                                <input type="hidden" name="id" value="<?php if (isset($hima->id)) {
                                                                            echo $hima->id;
                                                                        } ?>" required>
                                <input type="hidden" name="id_user" value="<?php if (isset($hima->id_user)) {
                                                                            echo $hima->id_user;
                                                                        } ?>" required>

                                <div class="form-group">
                                    <label for="exampleInputName1">Prodi</label>
                                    <input type="text" class="form-control" name="prodi" value="<?php if (isset($hima->prodi)) {
                                                                                                    echo $hima->prodi;
                                                                                                } ?>" id="exampleInputName1" placeholder="Username" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName1">Tahun Berdiri</label>
                                    <input type="text" class="form-control" name="tahun_berdiri" value="<?php if (isset($hima->tahun_berdiri)) {
                                                                                                            echo $hima->tahun_berdiri;
                                                                                                        } ?>" id="exampleInputName1" placeholder="Email" required>
                                </div>

                                <div class="form-group">
                                    <label for="exampleTextarea1">Akreditas</label>
                                    <input type="text" class="form-control" name="akriditas" value="<?php if (isset($hima->akriditas)) {
                                                                                                        echo $hima->akriditas;
