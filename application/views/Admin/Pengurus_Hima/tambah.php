                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="post" enctype="multipart/form-data" action="tambah_pengurus_action">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nim" id="exampleInputName1" placeholder="Nim">
                                </div>
                                <div class="form-group">
                                ...
                                <a href="<?php echo site_url('home/pengurus_hima') ?>" class="btn btn-light">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
