                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="post" enctype="multipart/form-data" action="../approve_proposal_action">
                                <input type="hidden" name="id" value="<?php if (isset($dokumen->id)) {
                                                                            echo $dokumen->id;
                                                                        } ?>" required>
                                <div class="form-group">
                                    <label for="exampleInputName1">Periode</label>
                                    <input type="text" class="form-control" name="priode" value="<?php if (isset($dokumen->priode)) {
                                                                                                        echo $dokumen->priode;
                                                                                                    } ?>" id="exampleInputName1" placeholder="Priode" disabled>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="status" id="membershipRadios1" value="2" checked="">
                                                    Diterima
