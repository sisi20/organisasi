  ...
  <div class="main-panel">
    <div class="content-wrapper">
      <div class="row flex-row-reverse bd-highlight mb-3">
        <div class="col-12">
          <a href="<?php echo site_url('dokumen/tambah_proposal') ?>">
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="text-center">
                                ...
                                <!-- <a href="<?php echo site_url('dokumen/edit_proposal/' . $value->id) ?>">
                                  <button class="btn btn-outline-facebook">Edit
                                    <i class="mdi mdi-lead-pencil btn-icon-append"></i>
                                  </button>
                                </a> -->
                                <a href="<?php echo site_url('dokumen/delete_proposal/' . $value->id) ?>">
                                  <button class="btn btn-outline-facebook">Delete
                                    <i class="mdi mdi-close-circle-outline btn-icon-append"></i>
                                  </button>
                                </a>
                                <a href="<?php echo site_url('dokumen/approve_proposal/' . $value->id) ?>">
                                  <button class="btn btn-outline-facebook">Approve

                                    <i class="mdi mdi-check-circle-outline btn-icon-append"></i>
                                  </button>
                                </a>
                              </td>
                            </tr>
                    ...
                    <div class="col-sm-12 col-md-7">
                      <div class="dataTables_paginate paging_simple_numbers" id="order-listing_paginate">
                        <ul class="pagination flex-row-reverse bd-highlight mb-3">
                          <li class="paginate_button page-item previous" id="order-listing_previous"><a href="#" aria-controls="order-listing" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li>
                          ...
                          <li class="paginate_button page-item next" id="order-listing_next"><a href="#" aria-controls="order-listing" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
